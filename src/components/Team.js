        ...
        <div className='mt-10 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-0 pb-10 sm:pb-14 text-center'>
          <div className='space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none'>
            ...
            <div className='bcm text-gray text-sm sm:text-base sm:w-7/12 px-6 mx-auto'>
              <p>
                The BLooted mokey was created by Sammy{' '}
                <strong>along with</strong>: Entrepreneurs, Blockchain
                experts, Marketing players, and Artists… We are committed to
                delivering a cutting-edge experience and making{' '}
